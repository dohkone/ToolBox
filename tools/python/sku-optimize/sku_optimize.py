...
COLORS: tuple[ColorSpec, ...] = (
    ColorSpec("black", "Black", "#0A0A0A", ("black", "black-cn")),
    ColorSpec("offwhite", "Off-white", "#F4F4F2", ("offwhite", "off-white", "offwhite-cn")),
    ColorSpec("yellowbrown", "Yellow brown", "#C19F7A", ("yellowbrown", "yellow-brown", "yellowbrown-cn")),
    ColorSpec("coffee", "Coffee", "#6F4E37", ("coffee", "coffee-cn")),
    ColorSpec("darkbrown", "Dark brown", "#261107", ("darkbrown", "dark-brown", "darkbrown-cn")),
    ColorSpec("darkgray", "Dark gray", "#C4C8CA", ("darkgray", "dark-grey", "darkgrey", "darkgray-cn")),
    ColorSpec("winered", "Wine red", "#722829", ("winered", "wine-red", "winered-cn")),
    ColorSpec("royalblue", "Royal blue", "#2E3EA5", ("royalblue", "royal-blue", "royalblue-cn")),
    ColorSpec("darkgreen", "Dark green", "#092C15", ("darkgreen", "dark-green", "darkgreen-cn")),
)
